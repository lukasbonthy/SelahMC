...
async function makeFakeClientRoot(parent) {
  ...
  await writeFile(
    join(target, "selahmc-client-v8.3.7.js"),
    "old-client-v8.3.7\n",
    "utf8",
  );
  return target;
...
test("installer preserves v8.3.3, creates a rollback backup, and installs atomically", async () => {
  ...
  try {
    ...
    assert.equal(
      await readFile(join(backup, "selahmc-client-v8.3.7.js"), "utf8"),
      "old-client-v8.3.7\n",
    );
...
test("corrupt package fails before changing the client root", async () => {
  ...
  try {
    ...
    await assert.rejects(stat(join(target, "selahmc-client-v8.3.8.js")), {
      code: "ENOENT",
    });
