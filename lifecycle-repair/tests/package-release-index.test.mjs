...
test("release rewrites one pinned Selah client script from a newer live index", () => {
  ...
  assert.equal(
    ...
    [
      "<html><body>",
      '<script>window.eaglercraftXClientScriptURL=new URL("selahmc-client-v8.3.10.js?v=5bd2a230",document.baseURI).href;</script>',
      '<script src="selahmc-client-v8.3.10.js?v=5bd2a230"></script>',
      "</body></html>",
    ].join("\n"),
  );
});
