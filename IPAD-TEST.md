# SelahMC v8.3.7 lifecycle test

This branch creates a private GitHub Codespace test server automatically.
It downloads the hash-pinned SelahMC v8.3.3 base, applies the tested v8.3.7
...
[Open the v8.3.7 test in GitHub Codespaces](https://codespaces.new/lukasbonthy/SelahMC/tree/lifecycle-barrier-v8.3.6?quickstart=1)
