...
test("Codespaces setup publishes the verified v8.3.8 lifecycle client", async () => {
  ...
  assert.equal(
    sha256(client),
    "f0797f8087977cb6428eec1d9564ece840922a23850cead6dffac54c2dd05bb2",
  );
  assert.match(index, /selahmc-client-v8\.3\.8\.js\?v=f0797f80/);
  assert.equal(
    sha256(bridge),
  ...
  assert.equal(
    (await stat(join(siteRoot, ".ready-v8.3.8-f0797f80-43daa2d9"))).isFile(),
    true,
  );
