...
release_client_sha="9c726f4aaddb31c7cd8a2c65d5832396761e1d617fb2eb35ee0d4811a581729d"
release_bridge_sha="43daa2d91bd9927b736543cd418766c383a037faec2a3d5725d7b1b786e62101"
release_marker=".ready-v8.3.10-9c726f4a-43daa2d9"
...
echo "Preparing SelahMC v8.3.10 from ${source_url}"
...
release_root="${repair_root}/dist/SelahMC-v8.3.10-Lifecycle-Transaction"
cp -- "${release_root}/index.html" "${stage}/index.html"
cp -- "${release_root}/selahmc-client-v8.3.10.js" \
  "${stage}/selahmc-client-v8.3.10.js"
...
${release_client_sha}  selahmc-client-v8.3.10.js
...
node --check "${stage}/selahmc-client-v8.3.10.js"
...
echo "SelahMC v8.3.10 is verified and ready."
