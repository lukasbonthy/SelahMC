...
release_marker=".ready-v8.3.9-5ed22bfe-43daa2d9"
...
echo "Preparing SelahMC v8.3.9 from ${source_url}"
...
release_root="${repair_root}/dist/SelahMC-v8.3.9-Lifecycle-Transaction"
cp -- "${release_root}/index.html" "${stage}/index.html"
cp -- "${release_root}/selahmc-client-v8.3.9.js" \
  "${stage}/selahmc-client-v8.3.9.js"
...
${release_client_sha}  selahmc-client-v8.3.9.js
...
node --check "${stage}/selahmc-client-v8.3.9.js"
...
echo "SelahMC v8.3.9 is verified and ready."
