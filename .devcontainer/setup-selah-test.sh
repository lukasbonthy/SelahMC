...
release_client_sha="bb6060cd64737bdd8c4f1ee899886b35723257dc28e814637e38453d2f7899dc"
release_marker=".ready-v8.3.8-bb6060cd"
...
echo "Preparing SelahMC v8.3.8 from ${source_url}"
...
release_root="${repair_root}/dist/SelahMC-v8.3.8-Lifecycle-Transaction"
...
node --check "${stage}/selahmc-client-v8.3.8.js"
...
echo "SelahMC v8.3.8 is verified and ready."
