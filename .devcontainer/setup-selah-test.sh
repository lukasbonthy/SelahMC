...
release_client_sha="5bd2a230cbb0313c862e753dc57b80feb70c75e2f2c193be6b10dd711e32efaf"
release_marker=".ready-v8.3.6-5bd2a230"
...
echo "Preparing SelahMC v8.3.6 from ${source_url}"
...
release_root="${repair_root}/dist/SelahMC-v8.3.6-Lifecycle-Barrier"
cp -- "${release_root}/index.html" "${stage}/index.html"
cp -- "${release_root}/selahmc-client-v8.3.6.js" \
  "${stage}/selahmc-client-v8.3.6.js"

(
  cd "${stage}"
  sha256sum --check <<SUMS
${release_client_sha}  selahmc-client-v8.3.6.js
...
node --check "${stage}/selahmc-client-v8.3.6.js"
...
echo "SelahMC v8.3.6 is verified and ready."
